...
<body>
	...
	<div id="page">
		...
		<div class="wrapper">
			...
			<form action="./YgddxxbServlet" method="post"
				onsubmit="return checkUser();" name="postForm">
				<input type="hidden" name="ygddxxbid" value="${ygddxxb.ygh}" /> <input
					type="hidden" name="action" value="updateygddxxb" />
				<table class="stylized full">
					...
					<tbody>
						...
						<tr>
							<td>原始部门</td>
							<td><input type="text" id="ygddxxbysbm" class="half"
								value="${ygddxxb.ysbm}" name="ygddxxbysbm" />
							</td>
						</tr>
						<tr>
							<td>原职位名称</td>
							<td><input type="text" id="ygddxxbyzwmc" class="half"
								value="${ygddxxb.yzwmc}" name="ygddxxbyzwmc" /></td>
						</tr>
						<tr>
							<td>原工资</td>
							<td><input type="text" id="ygddxxbygz" class="half"
								value="${ygddxxb.ygz}" name="ygddxxbygz" /></td>
						</tr>
						<tr>
							<td>新部门号</td>
							<td><input type="text" id="ygddxxbxbmh" class="half"
								value="${ygddxxb.xbmh}" name="ygddxxbxbmh" />
							</td>
						</tr>
						<tr>
							<td>新职位名称</td>
							<td><input type="text" id="ygddxxbxzwmc" class="half"
								value="${ygddxxb.xzwmc}" name="ygddxxbxzwmc" /></td>
						</tr>
						<tr>
							<td>新工资</td>
							<td><input type="text" id="ygddxxbxgz" class="half"
								value="${ygddxxb.xgz}" name="ygddxxbxgz" />
							</td>
						</tr>
						<tr>
							<td>调动时间</td>
							<td><input type="text" id="ygddxxbddsj" class="half"
								value="${ygddxxb.ddsj}" name="ygddxxbddsj" /></td>
						</tr>
						<tr>

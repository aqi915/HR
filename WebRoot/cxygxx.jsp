	...
	<div id="page">
		...
		<div class="wrapper">			
				...
				<tbody>
					...
					<c:forEach items="${ybxxbs}" var="ygxxb">
						<tr>
							<td class="center">${ygxxb.ygh}</td>
							<td class="center">${ygxxb.xm}</td>
							<td class="center">${ygxxb.sfzh}</td>
							<td class="center">${ygxxb.jg}</td>
							<td class="center"><a
								href="./ygxxbservlet?action=cxygxxxq&ygxxbid=${ygxxb.ygh}">详情</a> 
							</td>
						</tr>
					</c:forEach>
				</tbody>

...
<body>
	...
	<div id="page">
		...
		<div class="wrapper">
			...
			<form action="./YgzwxxbServlet" method="post"
				onsubmit="return checkUser();" name="postForm">
				<input type="hidden" name="ygzwxxbid" value="${ygzwxxb.ygh}" /> <input
					type="hidden" name="action" value="updateygzwxxb" />
				<table class="stylized full">
					...
					<tbody>
						...
						<tr>
							<td>职位名称</td>
							<td><input type="text" id="ygzwxxbzwmc" class="half"
								value="${ygzwxxb.zwmc}" name="ygzwxxbzwmc" /></td>
						</tr>
						<tr>

...
<body>
	...
	<div class="wrapper">
		...
		<ul class="sf-menu">
			...
			<li class="current"><a HREF="styles.html">人事管理</a>
				<ul>
	...
	<div id="page">
		...
		<div class="wrapper">
			<form action="./ygxxbservlet" method="post"
				...
				<input type="hidden" name="ygxxbid" value="${ygxxb.ygh}" /> <input
					type="hidden" name="action" value="updateygxxb" />
				<table class="stylized full">
					...
					<tbody>
						<tr>
							<td>员工号</td>
							<td><input type="text" id="ygxxbygh" class="half"
								value="${ygxxb.ygh}" name="ygxxbygh" />
							</td>
						</tr>
						<tr>
							<td>姓名</td>
							<td><input type="text" id="ygxxbxm" class="half"
								value="${ygxxb.xm}" name="ygxxbxm" /></td>
						</tr>
						<tr>
							<td>身份证号</td>
							<td><input type="text" id="ygxxbsfzh" class="half"
								value="${ygxxb.sfzh}" name="ygxxbsfzh" />
							</td>
						</tr>
						<tr>
							<td>性别</td>
							<td><select name="ygxxbxb">
									<option value="${ygxxb.xb}">男</option>
									<option value="${ygxxb.xb}">女</option>
							</select>
							</td>
						</tr>
						<tr>

...
<body>
	...
	<div class="wrapper">
		...
		<div id="topnav">
			...
			<a href="#">Logout</a><br /> <small>You have <a href="#"
				class="high"><b>1</b> new message!</a>
			</small>
		</div>
		...
		<!-- Aside links -->
		<aside>
		<b>English</b> &middot; <a href="#">Spanish</a> &middot; <a href="#">German</a></aside>
		<!-- End of Aside links -->
	</div>
	</header>
	<!-- End of Header -->
	...
	<div id="page">
		...
		<div class="wrapper">
			...
			<form action="./YgkqxxbServlet" method="post"
				onsubmit="return checkUser();" name="postForm">
				<input type="hidden" name="ygkqxxbid" value="${ygkqxxb.ygh}" /> <input
					type="hidden" name="action" value="updateygkqxxb" />
				<table class="stylized full">
					...
					<tbody>
						...
						<tr>
							<td>姓名</td>
							<td><input type="text" id="ygkqxxbxm" class="half"
								value="${ygkqxxb.xm}" name="ygkqxxbxm" /></td>
						</tr>
						<tr>
							<td>迟到</td>
							<td><input type="text" id="ygkqxxbcd" class="half"
								value="${ygkqxxb.cd}" name="ygkqxxbcd" />
							</td>
						</tr>
						<tr>
							<td>早退</td>
							<td><input type="text" id="ygkqxxbzt" class="half"
								value="${ygkqxxb.zt}" name="ygkqxxbzt" /></td>
						</tr>
						<tr>
							<td>旷工</td>
							<td><input type="text" id="ygkqxxbkg" class="half"
								value="${ygkqxxb.kg}" name="ygkqxxbkg" />
							</td>
						</tr>
						<tr>
							<td>请假</td>
							<td><input type="text" id="ygkqxxbqj" class="half"
								value="${ygkqxxb.qj}" name="ygkqxxbqj" />
							</td>
						</tr>
						<tr>
							<td>加班时间</td>
							<td><input type="text" id="ygkqxxbjbsj" class="half"
								value="${ygkqxxb.jbsj}" name="ygkqxxbjbsj" /></td>
						</tr>
						<tr>
							<td>考勤时间</td>
							<td><input type="text" id="ygkqxxbkqsj" class="half"
								value="${ygkqxxb.kqsj}" name="ygkqxxbkqsj" />
							</td>
						</tr>
						<tr>

		...
		<div class="wrapper">
			...
			<nav id="menu">
				<ul class="sf-menu">
					...
					<li>
						<a HREF="styles.html">人事管理</a>
						<ul>
							<li>
								<a HREF="cxygxx.html">查询员工信息</a>
							</li>
							<li>
								<a href="whygxx.html">维护员工信息</a>
								<ul>
					...
					<li><a HREF="tables.html">人事异动</a>
                    	<ul>
							<li>
								<a HREF="ygjz.html">员工就职</a>
							</li>
							<li>
								<a href="ygdd.html">员工调动</a>
							</li>
                            <li>
								<a HREF="yglz.html">员工离职</a>
							</li>
							<li>
								<a href="ygddcx.html">员工调动查询</a>
							</li>
						</ul>
                    </li>
					<li><a HREF="forms.html">奖惩管理</a>
                    	<ul>
							<li>
								<a HREF="jcxxcx.html">奖惩信息查询</a>
							</li>
							<li>
								<a href="jcxxwh.html">奖惩信息维护</a>
							</li>
						</ul>
                    </li>	
					<li><a HREF="graphs.html">系统管理</a>
                    	<ul>
							<li>
								<a HREF="bmxxwh.html">部门信息维护</a>
							</li>
							<li>
								<a href="mmxg.html">密码修改</a>
							</li>
                            <li>
								<a HREF="zwxxwh.html">职位信息维护</a>
							</li>
							<li>
								<a href="qxsz.html">权限设置</a>
							</li>
						</ul>
                    </li>	
                    <li class="current"><a HREF="tables.html">考勤管理</a>
                    	<ul>
							<li>
								<a HREF="kqxxcx.html">考勤信息查询</a>
							</li>
							<li>
								<a href="kqxxwh.html">考勤信息维护</a>
							</li>
						</ul>
                    </li>
					<li><a HREF="forms.html">工资管理</a>
                    	<ul>
							<li>
								<a HREF="gzxxcx.html">工资信息查询</a>
							</li>
							<li>
								<a href="gzxxwh.html">工资信息维护</a>
							</li>
                            <li>
								<a href="gzff.html">工资发放</a>
							</li>
						</ul>
                    </li>	
					<li><a HREF="graphs.html">帮助说明</a>
                    	<ul>
							<li>
								<a HREF="rjsm.html">软件说明</a>
							</li>
							<li>
								<a href="yhsc.html">用户手册</a>
							</li>
						</ul>
                    </li>
				</ul>
	...
	<div id="page">
		...
		<div class="wrapper">			
				...
				<tbody>
					...
					<c:forEach items="${ygkqxxbs}" var="ygkqxxb">
						<tr>
							<td class="center">${ygkqxxb.ygh}</td>
							<td class="center">${ygkqxxb.xm}</td>
							<td class="center">${ygkqxxb.cd}</td>
							<td class="center">${ygkqxxb.zt}</td>
							<td class="center">${ygkqxxb.kg}</td>
							<td class="center">${ygkqxxb.qj}</td>
							<td class="center">${ygkqxxb.jbsj}</td>
							<td class="center">${ygkqxxb.kqsj}</td>
							<td class="center"><a
								href="./YgkqxxbServlet?action=kqxxcxxq&ygkqxxbid=${ygkqxxb.ygh}">详情</a> 
							</td>
						</tr>
					</c:forEach>
				</tbody>

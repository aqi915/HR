...
nPreviousInner=document.createElement("span");nPreviousInner.className=oSettintgs.oClasses.sPageJUIPrev;
...
this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"显示 _MENU_ 条",sZeroRecords:"No matching records found",sInfo:"显示 _START_ 到 _END_ 共 _TOTAL_ 条",sInfoEmpty:"显示 0 到 0 共 0 条",sInfoFiltered:"(filtered from _MAX_ total 条)",sInfoPostFix:"",sSearch:"Search:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"}};

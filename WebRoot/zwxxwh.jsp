		...
		<div class="wrapper">
			...
			<table class="display stylized" id="example">
				...
				<tbody>
					...
					<c:forEach items="${ygzwxxbs}" var="ygzwxxb">
						<tr>
							<td class="center">${ygzwxxb.ygh}</td>
							<td class="center">${ygzwxxb.zwmc}</td>

							<td class="center"><a
								href="./YgzwxxbServlet?action=zwxxwhxg&ygzwxxbid=${ygzwxxb.ygh}">修改</a>
								<a
								href="./YgzwxxbServlet?action=deleteygzwxxb&ygzwxxbid=${ygzwxxb.ygh}">删除</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>

		...
		<div class="wrapper">
			...
			<table class="display stylized" id="example">
				...
				<tbody>
					...
					<c:forEach items="${bmxxbs}" var="bmxxb">
						<tr>
							<td class="center">${bmxxb.bmh}</td>
							<td class="center">${bmxxb.mc}</td>
							<td class="center">${bmxxb.bz}</td>
							<td class="center"><a
								href="./BmxxbServlet?action=bmxxwhxg&bmxxbid=${bmxxb.bmh}">修改</a>
								<a href="./BmxxbServlet?action=deletebmxxb&bmxxbid=${bmxxb.bmh}">删除</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>

	...
	<header id="top">
		<div class="wrapper">
			...
			<div id="topnav">
				...
				<span>|</span> <a href="Login.jsp">Logout</a><br />
			...
			<nav id="menu">
				<ul class="sf-menu">
					...
					<li><a HREF="tables.html">人事异动</a></li>
					<li><a HREF="forms.html">奖惩管理</a></li>	
					<li><a HREF="graphs.html">系统管理</a></li>	
					<li><a HREF="tables.html">考勤管理</a></li>
					<li><a HREF="forms.html">工资管理</a></li>	
					<li><a HREF="graphs.html">帮助说明、</a></li>	
				</ul>
			</nav>
				...
				<section class="column width6 first">
					...
					<div class="colgroup leading">
						<div class="column width3 first">
							<h3>Welcome back, <a href="#">${xm}</a></h3>
							<p>

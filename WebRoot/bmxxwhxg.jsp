...
<body>
	...
	<div class="wrapper">
		...
		<ul class="sf-menu">
			...
			<li class="current"><a HREF="graphs.html">系统管理</a>
				<ul>
	...
	<div id="page">
		...
		<div class="wrapper">
			...
			<form action="./BmxxbServlet" method="post"
				onsubmit="return checkUser();" name="postForm">
				<input type="hidden" name="bmxxbid" value="${bmxxb.bmh}" /> <input
					type="hidden" name="action" value="updatebmxxb" />
				<table class="stylized full">
					...
					<tbody>
						...
						<tr>
							<td>名称</td>
							<td><input type="text" id="bmxxbmc" class="half"
								value="${bmxxb.mc}" name="bmxxbmc" /></td>
						</tr>
						<tr>
							<td>备注</td>
							<td><input type="text" id="bmxxbbz" class="half"
								value="${bmxxb.bz}" name="bmxxbbz" />
							</td>
						</tr>
						<tr>

		...
		<div class="wrapper">
			...
			<nav id="menu">
				<ul class="sf-menu">
					...
					<li class="current"><a HREF="forms.html">工资管理</a>
                    	<ul>
							<li>
	...
	<div id="page">
		...
		<div class="wrapper">			
				...
				<tbody>
					...
					<c:forEach items="${sjgzbs}" var="sjgzb">
						<tr>
							<td class="center">${sjgzb.ygh}</td>
							<td class="center">${sjgzb.xm}</td>
							<td class="center">${sjgzb.sjgz}</td>
							<td class="center">${sjgzb.ffrq}</td>
							<td class="center"><a
								href="./SjgzbServlet?action=gzxxwhxg&sjgzbid=${sjgzb.ygh}">修改</a>
								<a
								href="./SjgzbServlet?action=deletesjgzb&sjgzbid=${sjgzb.ygh}">删除</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>

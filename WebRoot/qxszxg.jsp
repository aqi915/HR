...
<script type="text/javascript">
    	...
    	function checkUser(){
    		if(isNaN(postForm.goodprice.value)){
    			alert("价格请输入数字！！！");
    			return false;
    		}
    		if(isNaN(postForm.goodcount.value)){
    			alert("数量请输入数字！！！");
    			return false;
    		}
    		return true;
...
<body>
	...
	<div class="wrapper">
		...
		<div id="topnav">
			...
			</a> 欢迎 <b>${user.xm}</b> <span>|</span> <a href="#">Settings</a> <span>|</span>
	...
	<div id="page">
		...
		<div class="wrapper">
			<form action="./userservlet" method="post"
				...
				<input type="hidden" name="userid" value="${user.ygh}" /> 
				...
				<table class="stylized full">
					...
					<tbody>
						<tr>
							<td>员工号</td>
							<td><input type="text" id="userygh" class="half"
								value="${user.ygh}" name="userygh" /></td>
						</tr>
						<tr>
							<td>姓名</td>
							<td><input type="text" id="userxm" class="half"
								value="${user.xm}" name="userxm" />
							</td>
						</tr>
						<tr>
							<td>密码</td>
							<td><input type="text" id="usermm" class="half"
								value="${user.mm}" name="usermm" /></td>
						</tr>
						<tr>
							<td>权限</td>
							<td><input type="text" id="userqx" class="half"
								value="${user.qx}" name="userqx" />
							</td>
						</tr>
						<tr>

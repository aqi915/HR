		...
		<div class="wrapper">
			...
			<table class="display stylized" id="example">
				...
				<tbody>
					...
					<c:forEach items="${whygxxs}" var="whygxx">
						<tr>
							<td class="center">${whygxx.ygh}</td>
							<td class="center">${whygxx.xm}</td>
							<td class="center">${whygxx.sfzh}</td>
							<td class="center">${whygxx.jg}</td>
							<td class="center"><a
								href="./ygxxbservlet?action=whygxxxg&ygxxbid=${whygxx.ygh}">修改</a>
								<a
								href="./ygxxbservlet?action=deleteygxxb&ygxxbid=${whygxx.ygh}">删除</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
